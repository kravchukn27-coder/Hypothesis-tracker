  ...
  return (
    <span className="relative inline-block">
      ...
      <select
        ...
        className={`${BADGE_SHAPE_CLASSES} cursor-pointer appearance-none border-0 py-1 pr-7 pl-8 outline-none disabled:opacity-60 [-webkit-appearance:none] ${colorClasses}`}
      >
        {options.map((o) => (
