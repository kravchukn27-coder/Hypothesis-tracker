...
export function SetPasswordForm({ token }: { token: string }) {
  ...
  return (
    <form action={action} className="mt-5 space-y-4">
      ...
      <label className="block text-sm font-medium">Имя<input className="mt-1 w-full rounded-md border border-zinc-300 px-3 py-2" name="name" autoComplete="name" required /></label>
